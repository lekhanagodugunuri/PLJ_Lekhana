...
const formik = useFormik({
  ...
  const handleSubmit = (movieName:string, movieGenre:string, moviePrice:string)=>{
    if (id == undefined) {return;}
    updateMovie({movieId:id, movieName: movieName, movieGenre: movieGenre, moviePrice: moviePrice})
      .then((response: any) => {
